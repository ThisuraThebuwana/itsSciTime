                ...
                >
                    {(props)=>(
                        <View>
                            ...
                            <TouchableOpacity>
                                <Text style={globalStyles.editProfileButton} title='Save Changes'>Save Changes</Text>    
                            </TouchableOpacity>

                            <TouchableOpacity>
                                <Text style={globalStyles.editProfileButton} title='Delete Account'>Delete Account</Text>    
                            </TouchableOpacity>
