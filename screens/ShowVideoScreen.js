    ...
    return (
        ...
        <View style={styles.description}>
                ...
                <View style={{paddingLeft:180,paddingTop:20}}>
                   ...
                   <Text style={{paddingLeft:30}}></Text>
                      <TouchableOpacity style={{ backgroundColor: '#E53535',  margin:15,paddingHorizontal:30, paddingVertical:10}} onPress={() => navigation.navigate('Play Video1')}  >
       ...
       <View style={styles.description}>
               ...
               <View style={{paddingLeft:40}}>
                  ...
                  <Text style={{fontSize:24}}>Unit 3</Text>
       ...
       <View style={styles.description}>
               ...
               <View style={{paddingLeft:120,paddingTop:20}}>
                ...
                <Text style={{fontSize:18}}>RS.200</Text>
                 </View>
                  <Text style={{paddingLeft:30}}></Text>
                     <TouchableOpacity style={{ backgroundColor: '#E53535',  margin:15,paddingHorizontal:30, paddingVertical:10}} >
                       <Text style={{color:'#fff'}}>Buy</Text>
                   </TouchableOpacity>
        </View>
        </View>
